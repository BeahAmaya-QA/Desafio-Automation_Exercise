...
O Faker é uma biblioteca JavaScript utilizada para gerar dados fictícios realistas, como nomes, e-mails, endereços, telefones e datas. 
Esses dados são criados de forma aleatória, simulando informações reais usadas em sistemas.

Vantagens do uso de dados dinâmicos (Faker)
